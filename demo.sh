...
curl http://$CONTROLLER_IP:$CONTROLLER_REST_PORT/wm/sos/agent/add/json -X POST -d '{"ip-address":"10.0.0.11", "control-port":"9998", "data-port":"9877", "feedback-port":"9997", "stats-port":"9999"}' | python -m json.tool
curl http://$CONTROLLER_IP:$CONTROLLER_REST_PORT/wm/sos/agent/add/json -X POST -d '{"ip-address":"10.0.0.21", "control-port":"9998", "data-port":"9877", "feedback-port":"9997", "stats-port":"9999"}' | python -m json.tool
